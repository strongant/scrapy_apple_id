...
if __name__ == '__main__':
    ...
    while 1:
        ...
        if cmp(act, 'info') == 0: 
            ...
            result = client.http_request('http://code.chaojiying.net/Upload/GetScore.php', paramDict)
			
        elif cmp(act, 'reg') == 0:
            paramDict['user'] = raw_input('user:')
            paramDict['pass'] = raw_input('pass:')
            result = client.http_request('http://code.chaojiying.net/Upload/UserReg.php', paramDict)
			
        elif cmp(act, 'pay') == 0:
            paramDict['user'] = raw_input('user:')
            paramDict['card'] = raw_input('card:')
            result = client.http_request('http://code.chaojiying.net/Upload/UserPay.php', paramDict)
            ...
            result = client.http_request('http://code.chaojiying.net/Upload/ReportError.php', paramDict)
